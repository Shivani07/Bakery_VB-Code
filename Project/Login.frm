...
Begin VB.Form Form1 
   ...
   Begin VB.ComboBox Combo2 
      ...
      ForeColor       =   &H00404040&
      Height          =   360
      ItemData        =   "Login.frx":12592
      Left            =   6960
      List            =   "Login.frx":1262F
      TabIndex        =   10
      Text            =   "City (Select)"
      Top             =   4320
      Width           =   3255
   ...
   Begin VB.ComboBox Combo1 
      ...
      ForeColor       =   &H00404040&
      Height          =   360
      ItemData        =   "Login.frx":12816
      Left            =   2160
      List            =   "Login.frx":128B3
      TabIndex        =   5
      Text            =   "City (Select)"
      Top             =   6840
      Width           =   3015
   ...
   Begin VB.TextBox Text3 
      ...
      Left            =   2160
      TabIndex        =   3
      Text            =   "Building Name/Street/Locality"
      Top             =   5640
      Width           =   3015
   End
...
If (Text1.Text = "Name" Or Text2.Text = "House/Flat Number" Or Text3.Text = "Building Name/Street/Locality" Or Text4.Text = "Mobile" Or Combo1.DataChanged = False) Then
...
If Text1.Text = "" Then Text1.Text = "Name"
End Sub
...
If Text2.Text = "" Then Text2.Text = "House/Flat Number"
End Sub
...
If Text3.Text = "" Then Text3.Text = "Building Name/Street/Locality"
End Sub
...
If Text4.Text = "" Then Text4.Text = "Mobile"
End Sub
